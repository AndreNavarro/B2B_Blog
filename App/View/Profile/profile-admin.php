...
<body>
    ...
    <fieldset id="toggle-menu"><?php echo '<h2>Olá, '.$_SESSION["username"].'</h2>' ?>
      ...
      <button class="button" type="" href="" value="">Gerenciar postagens</button>
      <button class="button" type="" href="" value="">Gerenciar usuários</button>
      <button class="button" type="" href="" value="">Fazer Backup Geral</button>
